...
{   	// ADC1: PA1(pin 41)
	...
	ADC1->CR2 |=  (2<<28);		// EXTEN[1:0]: ADC_ExternalTrigConvEdge_Enable(Both Edge)
	ADC1->CR2 |= (0x0C<<24);	// ____________________________________
...
// PA2을 출력설정하고 Alternate function(TIM5_CH3)으로 사용 선언 
	...
	TIM5->CCMR2 |= (3<<4);	// OC3M=0b011: Output Compare 3 Mode : toggle
 	...
 	TIM5->CCR3 = 20000;	// TIM5 CCR3 TIM5_Pulse
