...
int main(void)
{
	...
	_GPIO_Init();
	_ADC_Init();
    ADC1->CR2 |= ADC_CR2_SWSTART; 	// 0x40000000 (1<<30) //한번만실행
	while(1)
	{
...
{   
	...
	ADC1->CR1 |= (2<<24);		// RES[1:0]=0b10 : 8bit Resolution
	...
	ADC1->SQR3 |= (1<<0);		// SQ1[4:0]=0b0001 : CH1  // 지우면 0번 채널로 인식 -> High impedence
