...
void TIMER5_Init(void); // Timer5 초기화
...
// Deciding the Period
	TIM3->PSC = 42000-1;	// Prescaler 84,000,000Hz/8400 = 10,000 Hz (0.1ms)  (1~65536)
	TIM3->ARR = 1000-1;		// Auto reload  0.1ms * 10 = 1ms
...
// Deciding the Period
	TIM5->PSC = 42000-1;	// Prescaler 84,000,000Hz/8400 = 10,000 Hz (0.1ms)  (1~65536)
	TIM5->ARR = 1000-1;		// Auto reload  0.1ms * 10 = 1ms
