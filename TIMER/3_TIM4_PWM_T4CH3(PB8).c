...
// TIM4 Channel 3 : PWM 1 mode
	...
	TIM4->PSC	= 8400-1;	// Prescaler 84,000,000Hz/840 = 10,000 Hz(0.01ms)  (1~65536)
	TIM4->ARR	= 100-1;	// Auto reload  (0.01ms * 1000 = 10ms : PWM Period)
	...
	TIM4->CR1 |= (2<<5);    // CMS(Center-aligned mode2 Sel)=10 : Edge-aligned mode
	...
	TIM4->CCMR2	|= (7<<4);	// OC3M=0b110: Output compare 3 mode: PWM 1 mode
